...
function test_can_pref_off_account_provisioner() {
  ...
  // We have to wait for the popup menu to be closed, or else we get weird
  // behaviour
  mc.waitFor(function() {
    return fileMenuPopup.getNode().state == "closed";
  }, "Timed out waiting for the File menu popup to be hidden");
